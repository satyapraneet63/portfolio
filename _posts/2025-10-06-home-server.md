...
I self-host a bunch of services on a Raspberry Pi 5 with a 1TB SSD, using Docker for orchestration.
...
There's nothing like building a system from scratch that just works — and then constantly tweaking it anyway.
